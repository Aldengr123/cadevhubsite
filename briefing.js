...
(function(){
  const FORM_ENDPOINT = 'enviar-briefing.php';
  ...
  function collect(){
    ...
    data.hp = hp ? hp.value : '';
    data._tipo = 'Identidade Visual + Landing Page + Infoproduto';
    return data;
  }
  ...
  submitBtn.addEventListener('click', async ()=>{
    ...
    const data = collect();
    try{ localStorage.setItem('cadev_briefing', JSON.stringify(data)); }catch(e){}
